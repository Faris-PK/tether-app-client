...
import { Bell, MessageCircle, Sun, Moon, ChevronDown, LogOut, PenSquare } from 'lucide-react';
...
const HeaderNav: React.FC<HeaderNavProps> = ({ onPostCreated }) => {
  ...
  const handlePostModalClose = () => {
    ...
    onPostCreated(); // Refresh posts after closing the modal
  };
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={`flex items-center space-x-2 rounded-full px-4 py-2 shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-105 shadow- ${
                isDarkMode 
