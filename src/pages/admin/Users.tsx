...
import { 
  Search, ArrowUpDown, Eye, UserCog, Ban, CheckCircle, 
  MapPin, Calendar, Link2, Users as UsersIcon, ChevronLeft, ChevronRight 
} from 'lucide-react';
...
const Users = () => {
  ...
  const handleManageUserStatus = async (userId: string, currentStatus: boolean) => {
    try {
      await adminApi.toggleUserBlock(userId, !currentStatus);
      ...
      if (selectedUser && selectedUser._id === userId) {
        setSelectedUser(prevUser => 
          prevUser ? { ...prevUser, isBlocked: !currentStatus } : null
        );
      }
    } catch (error) {
              ...
              <tbody>
                {users.map((user, index) => (
                  <tr key={user._id} className="border-b hover:bg-gray-50">
                    <td className="p-3 hidden md:table-cell">{(currentPage - 1) * 10 + index + 1}</td>
                    <td className="p-3">
                    ...
                    <td className="p-3 text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem
                            onClick={() => handleManageUserStatus(user._id, user.isBlocked)}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-4 pt-4">
                    ...
                    <Button
                      ...
                      onClick={() => handleManageUserStatus(selectedUser._id, selectedUser.isBlocked)}
                    >
